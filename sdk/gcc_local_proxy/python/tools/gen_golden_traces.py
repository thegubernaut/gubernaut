...
Output: core/tests/golden/traces.jsonl  (one JSON object per line)
Run:    python tools/gen_golden_traces.py   (from python/, lane venv)
"""
...
OUT = (Path(__file__).resolve().parent.parent.parent
       / "core" / "tests" / "golden" / "traces.jsonl")
