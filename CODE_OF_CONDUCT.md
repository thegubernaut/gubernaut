...
**Disagreeing with a published number is not misconduct. It is the point.**

This project publishes measured figures and asks people to re-run them. Reporting a result
that contradicts ours, questioning a method, or pointing out that a claim outruns its
evidence is all welcome and is exactly the behaviour the reproduction workflow exists to
invite. Bring the data.

Being rude about it is a separate matter, and that is what this document covers.
...
**1. Correction.** A private written warning, with clarity about the nature of the
...
interaction with the people involved for a specified period. Violating these terms may lead
